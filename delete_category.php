...
<div class="bouton_container" id="delete">
<div class="fake">
        <label for="categories" id="fake">Category</label>
        <input type="text" id="fake"  name="name" value="">
    ...
    <div class="submit">
        <button type="submit" class="bouton" name="Bouton">DELETE CATEGORY</button>
    </div>
</div>
<?php 
...
if(isset($_POST['name'])){
    ...
    if($verification){
    echo $name. " deleted";
    header( "refresh:2; delete_category.php" ); 
    }
}}
?>